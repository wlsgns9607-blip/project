...
## 📎 제출 서류 및 포트폴리오 안내 (Application Info)

채용 공고에서 요구하신 **필수 요건**을 모두 충족하여 서류를 준비했습니다.
- **이력서 및 자기소개서**: 잡코리아 양식 제출 (희망연봉 기재, 최근 사진 첨부 완료)
- **포트폴리오 형식**: 웹사이트 랜딩페이지 제공
- **기획 산출물**: 핵심 유저 여정을 담은 **골든패스 기획서(PRD)** 제공
- **프로젝트 정보**: 각 프로젝트별 **참여도 및 역할(Role)** 상세 기재 완료
...
### 1. 세차의정석
> **2년의 디테일링 세차 경험을 바탕으로 만든 단계별 세차 가이드 앱**
...
> **프리미엄 세차용품 쇼핑몰**
- **참여도 및 역할**: 서비스 기획(본인 85%, AI 정리 15%) / UX·UI 기획(본인 80%, AI 정리 20%) / 개발(FE/BE 등 AI 협업)
- 전문가 추천 제품과 상세한 설명 제공.
- 지그재그(Z패턴) 레이아웃 적용으로 사용자 시선 흐름을 유도.
